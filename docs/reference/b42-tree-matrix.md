...
Where the mod has already changed something, or has settled on how it will read a vanilla
fact, that is called out at the point it applies and nowhere else. Work that is only
planned lives in [docs/future/](../future/), not here.
